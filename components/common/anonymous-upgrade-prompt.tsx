...
export default function AnonymousUpgradePrompt({
  isOpen,
  onClose,
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              You currently have a <strong>temporary session</strong>. Your data
              will be lost when you clear your browser data.
            </AlertDescription>
          </Alert>
          ...
          <div className="text-xs text-center text-muted-foreground space-y-1">
            <p>
              ✅ Your existing data will be automatically migrated when you sign
              in
            </p>
            <p>
