            ...
            <CardContent>
              <div className="grid gap-8 md:grid-cols-3">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-3 text-slate-800 dark:text-white">Add your crew</h3>
                  <p className="text-slate-600 dark:text-slate-300">
                    Include everyone who's part of the fun. Start tracking expenses as they happen.
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-3 text-slate-800 dark:text-white">Settle up with ease</h3>
                  <p className="text-slate-600 dark:text-slate-300">
                    See who owes what in a clear, friendly breakdown. No awkward conversations needed.
                  </p>
                </div>
              </div>
            </CardContent>
