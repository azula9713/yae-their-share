...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ChevronDown
      className="relative top-px ml-1 transition duration-200 group-data-[state=open]:rotate-180 size-3"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] rotate-45 rounded-tl-sm bg-border shadow-md size-2" />
  </NavigationMenuPrimitive.Indicator>
))
